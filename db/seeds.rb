...
# Create users
users = User.create([{ name: 'Joe Kasongo', photo: '1.jpg',
                       bio: 'A passionate developer and a great cooker. PDG of JKLM group. 26 years old.',
                       posts_counter: 3 },
...
quis reprehenderit officia non. Consequat magna consequat officia
...
laboris ad proident. Eiusmod do pariatur mollit et ut anim voluptate
...
Exercitation eiusmod mollit ullamco qui commodo labore ',
...
sunt culpa. Nulla ex sit commodo elit culpa adipisicing id anim ad magna
occaecat id ullamco proident. Sunt tempor ex irure officia elit laboris
quis reprehenderit officia non. Consequat magna consequat officia tempo
Incididunt id sint ad reprehenderit qui fugiat tempor ullamco mollit aliqua.
Occaecat est qui eiusmod aliquip magna sint exercitation laboris ullamco
...
Reprehenderit commodo mollit fugiat duis excepteur nulla nisi culpa.
Consequat qui officia in deserunt laborum aute sit quis aute esse consectetur sunt elit proident.
Exercitation eiusmod mollit ullamco qui commodo labore fugiat. Reprehenderit et deserunt non ipsum.',
                        comments_counter: 0, likes_counter: 0 },
...
fringilla non. Sed eget risus posuere, ornare orci eu, feugiat sem..',
                        comments_counter: 0, likes_counter: 0 }
                    ])

# Create comments
Comment.create([{ post: posts.first, user: users.first, text: 'Can you give me your contact?' },
